...
2. Add a clean first-run onboarding flow that explains the board, importing, creating notes/code cards, search, and the window overlay controls. It must be skippable and never block opening an existing project.
