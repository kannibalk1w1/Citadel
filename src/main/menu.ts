  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { type: 'separator' },
        { label: 'Always on Top', accelerator: 'CmdOrCtrl+Alt+T', click: () => send('menu:alwaysOnTopToggle') },
        { label: 'Click Through', accelerator: 'CmdOrCtrl+Alt+C', click: () => send('menu:clickThroughToggle') },
        { type: 'separator' },
        { role: 'toggleDevTools' },
        { role: 'reload' },
      ],
